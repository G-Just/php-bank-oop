<body>
    <div class="p-4 grid grid-cols-3 grid-rows-2 w-full gap-4 bg-[url('/../img/bg_pattern.jpg')] bg-cover">
        ...
        <div class="relative p-8 pt-4 overflow-hidden text-center rounded-lg shadow-lg bg-slate-800">
            ...
            <div class="flex flex-col h-full pt-4 overflow-y-auto gap-11">
                <?php if (isset($_SESSION['id'])) { ?>
                    ...
                    <?php endforeach ?>
                <?php } else { ?>
                    <p class="absolute text-2xl -translate-x-1/2 top-1/2 left-1/2">Login to view logs</p>
                <?php  } ?>
            </div>
        </div>
        <div class="relative col-span-2 p-8 pt-4 overflow-hidden text-center rounded-lg shadow-lg bg-slate-800">
            ...
            <?php } else { ?>
                <p class="absolute text-2xl -translate-x-1/2 top-1/2 left-1/2">Login to view statistics</p>
            <?php  } ?>
        </div>
    </div>
</body>
