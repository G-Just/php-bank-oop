    ...
    <div class="flex flex-col justify-between h-screen p-4 pb-2 border-r-2 min-w-80 bg-slate-900 border-neutral-700">
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-col items-start w-full gap-6 pl-8 mt-14">
                <a class="flex gap-4 text-2xl hover:text-teal-600 hover:underline" href="./"><img class="w-7 h-w-7" src="img/home.svg" alt="">Home</a>
                <a class="flex gap-4 text-2xl hover:text-teal-600 hover:underline" href="./new"><img class="w-7 h-w-7" src="img/create.svg" alt="">Create account</a>
                <a class="flex gap-4 text-2xl hover:text-teal-600 hover:underline" href="./users"><img class="w-7 h-w-7" src="img/list.svg" alt="">User List</a>
            </div>
        </div>
        <div class="flex flex-col items-center">
            <div class="flex flex-col items-start w-full gap-6 pl-8 mt-14">
