    ...
    <div class="flex flex-col justify-between h-screen p-4 pb-2 border-r-2 min-w-80 bg-slate-900 border-neutral-700">
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-col items-start w-full gap-6 pl-8 mt-14">
                ...
                <a class="flex gap-4 text-2xl hover:text-slate-500 hover:underline" href="./newAccount"><img class="w-7 h-w-7" src="../public/img/create.svg" alt="">Create account</a>
                <a class="flex gap-4 text-2xl hover:text-slate-500 hover:underline" href="./userList"><img class="w-7 h-w-7" src="../public/img/list.svg" alt="">User List</a>
            </div>
        </div>
        <div class="flex flex-col items-center">
            <div class="flex flex-col items-start w-full gap-6 pl-8 mt-14">
